...
import ArticleCard from "../features/SingleArticle/components/ArticleCard";
...
import useSubmitArticle from "../features/NewArticle/hooks/useSubmitArticle";
      ...
      >
        ...
        >
          ...
          <ButtonGroup spacing={2} pt={{ base: 1, md: 0 }}>
            ...
            <Button variant="blue" onClick={submitArticle}>Submit</Button>
          </ButtonGroup>
        </Flex>
