...
export default function Statistics({ setActiveStep, newVote, setNewVote }) {
  console.log(getNames());
  return (
    <>
      <Heading mb={10}>Please provide some demographic data</Heading>
      ...
      <FormControl mt={4}>
        ...
        <FormHelperText>This is the gender on your ID card / passport / other legal documents.</FormHelperText>
      </FormControl>
